...
class ModifyingASceneApi:
    ...
    def delete_default_scene(
        ...
        _param = self._delete_default_scene_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_default_scene_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def delete_default_scene_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _delete_default_scene_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def delete_scene(
        ...
        _param = self._delete_scene_serialize(
            scene_id=scene_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_scene_with_http_info(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_scene_without_preload_content(
        self,
        scene_id: Annotated[StrictStr, Field(description="The unique identifier of the scene")],
        _request_timeout: Union[
            None,
