...
class ScanToModelRequest(BaseModel):
    ...
    files: Optional[List[StrictStr]] = Field(default=None, description="Array of paths to the files to load")
    ...
    hollow: Optional[StrictBool] = Field(default=None, description="Whether to hollow the model.")
    enable_honeycomb_infill: Optional[StrictBool] = Field(default=True, description="Whether to enable honeycomb infill when hollowing the model.")
    ...
    drain_hole_suppression_distance_mm: Optional[Union[StrictFloat, StrictInt]] = Field(default=2, description="When generating draining holes, don't attempt to place them within this distance of each other. In other words, this controls the minimum distance between drain holes. Requires hollow=true.")
    drain_hole_max_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=2, description="For each curve on the bottom of the model, place at most this many drain holes. Requires hollow=true.")
    enable_smooth_contour_extended_sides: Optional[StrictBool] = Field(default=True, description="Whether to enable smoothing contours that are extended from the bottom of the model to form base sides.")
    __properties: ClassVar[List[str]] = ["file", "files", "units", "cutoff_height_mm", "extrude_distance_mm", "hollow", "enable_honeycomb_infill", "cutoff_below_gumline_mm", "shell_thickness_mm", "wall_thickness_mm", "drain_hole_radius_mm", "drain_hole_height_ratio", "drain_hole_suppression_distance_mm", "drain_hole_max_count", "enable_smooth_contour_extended_sides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enable_honeycomb_infill": obj.get("enable_honeycomb_infill") if obj.get("enable_honeycomb_infill") is not None else True,
            ...
            "drain_hole_suppression_distance_mm": obj.get("drain_hole_suppression_distance_mm") if obj.get("drain_hole_suppression_distance_mm") is not None else 2,
            "drain_hole_max_count": obj.get("drain_hole_max_count") if obj.get("drain_hole_max_count") is not None else 2,
            "enable_smooth_contour_extended_sides": obj.get("enable_smooth_contour_extended_sides") if obj.get("enable_smooth_contour_extended_sides") is not None else True
        })
        return _obj
