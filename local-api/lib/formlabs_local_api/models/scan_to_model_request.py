...
class ScanToModelRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file", "files", "units", "cutoff_height_mm", "extrude_distance_mm", "hollow", "cutoff_below_gumline_mm", "shell_thickness_mm", "wall_thickness_mm", "drain_hole_radius_mm", "drain_hole_height_ratio"]
