...
class LabelPartRequest(BaseModel):
    ...
    orientation: OrientationModel = Field(description="The orientation of the label (+x left-to-right along text, +y top-to-bottom along text, +z normal to text plane).")
    position: ScenePositionModel = Field(description="The desired center point of the label")
